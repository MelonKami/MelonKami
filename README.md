<img src="https://personlig-bilskilt.storbukas.no/svart/Marius">
...
I have experience with SSH, Remote Desktop Connection, Server delevopment (FiveM server), JS, Python, LUA (little), Discord bots (written in python), API's, processing API data for usage (for example server information), HTML & CSS, Flask (python web server)
